...
class ObjectDefinition implements Definition
{
    ...
    public function getMethodInjections() : array
    {
        ...
        array_walk_recursive(
            $this->methodInjections, function ($injection) use (&$injections) {
    ...
    {
        array_walk(
            $this->propertyInjections, function (PropertyInjection $propertyInjection) use ($replacer) {
        ...
        array_walk(
            $this->methodInjections, function ($injectionArray) use ($replacer) {
                array_walk(
                    $injectionArray, function (MethodInjection $methodInjection) use ($replacer) {
